...
class ControllerGUI(tk.Frame):
    def __init__(self,controller_node, *args, **kwargs):
        ...
        self.reset_button = tk.Button(text='reset', command = controller_node._set_cube_state_client)
...
class SimulationController(object):
    ...
    def __init__(self, name='simulationcontroller', objectname='unit_box'):
        ...
        self.modelstate.model_name = 'unit_box'
    ...
    def _set_cube_state_client(self):
